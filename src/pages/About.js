    ...
    <>
      ...
      <div className="about-page-container">
        <div className="about-container">
          ...
          <p>
            Having worked continuously for 6 years since my marriage, I never
            had a chance to reconsider my career path. But new ideas and goals
            came to my mind, and I started to explore different options. I was
            interested in the tech industry, and programmers often don't have a
            strong need for formal education. Access to free online resources
            made me feel that frontend development might be the answer.
          </p>
          <img
            loading="lazy"
            className="about-img"
          ...
          <p>
            ...
            Html and Css and could do the appearance and template of my
            exercises, which were usually from W3Schools and YouTube videos.
            After that, I started learning JavaScript and after 1 month, I
            realized that to speed up the learning process and understand the
            content more deeply, I should use a non-free and professional
            resource.<br></br>
          ...
          <p>
            ...
            face a problem, I struggled with, and couldn’t move further because
            of it. But during this year I always found a way to solve it,
            sometimes it took me days and numerous attempts. I enjoyed the
            challenge and landing on the right solution.
          </p>
          <p>
            I have a passion for web development. It gives me the possibility to
            challenge myself and use a mix of technologies and creativity. I
            like being able to see the result quickly and the endless learning
            process.
            <br></br>
          ...
          <p>
            I am now ready to cooperate and join a professional team so that I
            can use my skills to help them and also improve myself by learning
            new skills and experiences from them. Looking for a local or remote
